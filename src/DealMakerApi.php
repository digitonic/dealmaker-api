...
use Digitonic\DealmakerApi\Resource\Deals;
use Digitonic\DealmakerApi\Resource\DealSetup;
use Digitonic\DealmakerApi\Resource\Investor;
use Digitonic\DealmakerApi\Resource\InvestorProfile;
use Digitonic\DealmakerApi\Resource\Misc;
use Digitonic\DealmakerApi\Resource\Shareholder;
use Digitonic\DealmakerApi\Resource\Upload;
use Digitonic\DealmakerApi\Resource\Users;
...
class DealMakerApi extends Connector
{
    ...
    public function dealSetup(): DealSetup
    {
        return new DealSetup($this);
    }
